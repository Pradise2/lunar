...
const Farm = () => {
  ...
  return (
    ...
    <div className="flex-grow flex flex-col items-center justify-center">
        ...
        <div className="bg-gradient-to-r from-purple-800 to-indigo-800 text-center py-2 px-4 rounded-lg flex justify-center items-center mt-5">
            <span className="material-icons mr-2">access_time</span>
            <p className="font-bold"><FormattedTime time={farmTime} /></p>
        </div>
